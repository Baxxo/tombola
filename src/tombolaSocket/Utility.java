...
public class Utility {
	...
	// Se INFO_OUTPUT è false, tutte le classi diventeranno "silenziose": tutto
	// l'output
	// delle classi passa attraverso il metodo Utility.info, quindi basta porre
	// INFO_OUTPUT
	...
	// Controlla se un numero è presente in un array e ne restituisce l'indice,
	// o -1 se non presente
